module constants
  ...
  ! Zero point energies of O2 are taken as a result of program zpeO2
                       zpe_66 = 794.5121300074147d0 / autown, &
                       zpe_68 = 769.3708063017872d0 / autown, &
                       zpe_88 = 748.9861634170745d0 / autown, &
  ! Obtained as energy of dissociated O3 on ozone PES of Dawes for r1 = 900 Bohr, angle = 90 deg (does not matter which one), r2 is optimized to 10^-15 precision
