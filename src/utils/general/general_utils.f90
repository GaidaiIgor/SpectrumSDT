module general_utils_mod
  use general_utils_integer_mod
  use general_utils_real_mod
  use general_utils_real_array_mod
  ...
  interface delta
    module procedure :: delta_int, delta_real
  end interface
...
!-------------------------------------------------------------------------------------------------------------------------------------------
  function delta_int(a, b) result(res)
...
! Evaluates delta Kronecker function.
!-------------------------------------------------------------------------------------------------------------------------------------------
  function delta_real(a, b) result(res)
...
!-------------------------------------------------------------------------------------------------------------------------------------------
! Conjugates a real number, i.e. identity function.
!-------------------------------------------------------------------------------------------------------------------------------------------
  elemental function conjg_real(a) result(b)
    real(real64), intent(in) :: a
    real(real64) :: b
    b = a
  end function
