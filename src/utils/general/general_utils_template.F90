#include "funcs.macro"
  ...
  interface arg_or_default
    module procedure :: CONCAT2(arg_or_default_,TEMPLATE_TYPE_NAME)
  end interface

  interface iff
    module procedure :: CONCAT2(iff_,TEMPLATE_TYPE_NAME)
  end interface

  interface swap
    module procedure :: CONCAT2(swap_,TEMPLATE_TYPE_NAME)
  end interface
