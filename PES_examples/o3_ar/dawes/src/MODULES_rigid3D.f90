MODULE dynamic_parameters
 ...
 real*8 :: epss,acc,rmax(XDIM),rmin(XDIM),poten,ugrad,Max_E,Max_E_seed,E_range,dist_tol
 real*8 :: E_limit,W_a,alpha,Glob_min
 ...
 integer :: low_grid,subzero,dist_flag,nfold,flip,reflect,symparts
 character(len=3),allocatable :: symb(:)

END MODULE dynamic_parameters

MODULE dynamic_parameters_2
...
END MODULE dynamic_parameters_2
